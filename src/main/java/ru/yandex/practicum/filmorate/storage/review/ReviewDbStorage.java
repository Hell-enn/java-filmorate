...
public class ReviewDbStorage implements ReviewStorage {
    ...
    public Review addReview(Review review) {
        ...
        addEvent(new Event(System.currentTimeMillis(), review.getUserId(), "REVIEW", "ADD", review.getReviewId()));
    ...
    public Review updateReview(Review review) {
        ...
        addEvent(new Event(System.currentTimeMillis(), review.getUserId(), "REVIEW", "UPDATE", review.getReviewId()));
